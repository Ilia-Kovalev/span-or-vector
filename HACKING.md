...
hidden if the `span_or_vector_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `span_or_vector_DEVELOPER_MODE` to the configure
